...
export function brandHeaderHtml(hasInlineLogo: boolean): string {
  const inner = hasInlineLogo
    ? `<img src="cid:${LOGO_CID}" alt="AlmaMundi" width="180"
        style="display:block;margin:0 auto;width:180px;height:auto;max-height:72px;border:0;outline:none;text-decoration:none">`
