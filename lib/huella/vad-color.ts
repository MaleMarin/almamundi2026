/**
 * VAD → HSL para resonancia visual AlmaMundi.
...
export function colorizeVadHits<T extends VadTriple>(hits: T[]): Array<ColorizedVadHit<T>> {
...
/** Con pocas palabras, abanico de tonos vecinos. */
export function expandSparseVadColors<T extends ColorizedVadHit<VadTriple>>(colored: T[]): T[] {
