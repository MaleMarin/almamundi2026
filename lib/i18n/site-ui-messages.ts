...
const es: SiteUiMessages = {
  ...
  archivoEmpty: 'Aún no hay historias en el archivo.',
  archivoAll: 'Todos',
  archivoEmptyTheme: 'No hay historias con ese tema.',
...
const pt: SiteUiMessages = {
  ...
  archivoEmpty: 'Ainda não há histórias no arquivo.',
  archivoAll: 'Todos',
  archivoEmptyTheme: 'Não há histórias com esse tema.',
...
const en: SiteUiMessages = {
  ...
  archivoEmpty: 'There are no stories in the archive yet.',
  archivoAll: 'All',
  archivoEmptyTheme: 'There are no stories with that theme.',
