  ...
  return (
    <div className="overflow-hidden rounded-[10px] border border-[#D4D4C4] bg-white">
      ...
      <div className="px-2.5 py-2">
        <div className="mb-0.5 text-[9px] font-semibold tracking-wide text-[#FF4A1C]">{id}</div>
    ...
    <div className={`min-h-screen bg-[#F0EFE9] px-6 py-8 pb-16 text-[#141D26] ${jakarta.className}`}>
      <div className="mx-auto max-w-[960px]">
        ...
        <section className="mb-10">
          <div className="mb-3 text-[10px] font-semibold uppercase tracking-[0.14em] text-[#FF4A1C]">
          ...
          <div className="mb-4 rounded-xl border border-[#D4D4C4] bg-white p-5">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                type="button"
                onClick={generar}
                className="rounded-lg bg-[#FF4A1C] px-5 py-2 text-sm font-semibold text-white hover:bg-[#D13D17]"
              >
        ...
        <section>
          <div className="mb-4 text-[10px] font-semibold uppercase tracking-[0.14em] text-[#FF4A1C]">
