                ...
                <div className="absolute inset-0 bg-white z-[300] flex flex-col items-center justify-center p-4 anim-final-in overflow-hidden">
                    ...
                    <div className="w-full max-w-2xl text-center">
                        ...
                        <div className="flex flex-wrap justify-center gap-3 mb-10">
                            ...
                            <a href={shareLinks.facebook} target="_blank" className="w-10 h-10 flex items-center justify-center text-white bg-[#e63e00] rounded-full hover:scale-110 shadow-lg"><Facebook size={18} /></a>
                            ...
                            <a href={shareLinks.linkedin} target="_blank" className="w-10 h-10 flex items-center justify-center text-white bg-[#ff4500] rounded-full hover:scale-110 shadow-lg"><Linkedin size={18} /></a>
      ...
      {step !== 'success' && (
          <div className="flex-none h-16 w-full border-t border-gray-300/30 bg-[#E0E5EC] flex items-center justify-center px-4 relative z-[210]">
             <div className="flex gap-4 md:gap-8 text-[10px] md:text-xs font-bold uppercase tracking-widest text-gray-500">
                ...
                <button onClick={() => { setMode('video'); setStep('intro'); }} className={`flex items-center gap-2 ${mode === 'video' ? 'text-orange-600' : 'hover:text-gray-800'}`}><Video size={16} /> Video</button>
                <button onClick={() => { setMode('audio'); setStep('intro'); }} className={`flex items-center gap-2 ${mode === 'audio' ? 'text-orange-600' : 'hover:text-gray-800'}`}><Mic size={16} /> Audio</button>
                <button onClick={() => { setMode('text'); setStep('writing'); }} className={`flex items-center gap-2 ${mode === 'text' ? 'text-orange-600' : 'hover:text-gray-800'}`}><PenTool size={16} /> Texto</button>
             </div>
          </div>
      )}
    </div>
