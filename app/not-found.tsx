...
export default function NotFound() {
  return (
    <main className="min-h-screen w-full flex flex-col items-center justify-center p-6 bg-[#E0E5EC] text-slate-800">
      <div className="max-w-3xl w-full p-10 md:p-14 rounded-[40px] shadow-[12px_12px_20px_#bfc6cc,-12px_-12px_20px_#ffffff] bg-[#E0E5EC] border-4 border-[#AB301C]">
        ...
        <nav className="grid grid-cols-1 sm:grid-cols-2 gap-8 mt-12">
          <HomeHardLink
            ...
            className="group flex items-center gap-5 p-6 rounded-3xl transition-all duration-300 shadow-[8px_8px_16px_#bfc6cc,-8px_-8px_16px_#ffffff] hover:shadow-[4px_4px_8px_#bfc6cc,-4px_-4px_8px_#ffffff] bg-[#E0E5EC] text-slate-800 hover:text-[#AB301C]"
          >
            <div className="p-4 rounded-full bg-[#E0E5EC] group-hover:bg-[#AB301C]/5 shadow-[inner_4px_4px_8px_#bfc6cc,inner_-4px_-4px_8px_#ffffff]">
              <MapPin className="size-8 text-[#AB301C]" />
            </div>
            <div>
            ...
            <CornerDownLeft className="ml-auto size-6 text-slate-500/60 group-hover:text-[#AB301C] transition-colors" />
          </HomeHardLink>
          <Link
          ...
          >
            <div className="p-4 rounded-full bg-[#E0E5EC] group-hover:bg-[#AB301C]/5 shadow-[inner_4px_4px_8px_#bfc6cc,inner_-4px_-4px_8px_#ffffff]">
              <Video className="size-8 text-[#AB301C]" />
            </div>
            <div>
        ...
        <footer className="mt-14 text-center border-t border-slate-300 pt-8">
          <HomeHardLink
            href="/"
            className="inline-flex items-center gap-2.5 text-slate-700 hover:text-[#AB301C] group transition-colors"
          >
            <Home size={18} className="text-slate-500 group-hover:text-[#AB301C]" />
            Ir al inicio
          </HomeHardLink>
        </footer>
      </div>
