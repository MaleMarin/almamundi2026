          ...
          {(
            ...
            <button
              ...
              style={{
                padding: '12px 24px',
                borderRadius: 999,
                border: `1px solid ${view === tab.id ? 'rgba(171,48,28,0.5)' : 'rgba(255,255,255,0.2)'}`,
                background: view === tab.id ? 'rgba(171,48,28,0.15)' : 'rgba(255,255,255,0.05)',
                color: view === tab.id ? '#C44532' : 'rgba(255,255,255,0.85)',
                fontSize: 15,
                fontWeight: 600,
                cursor: 'pointer',
                fontFamily: APP_FONT,
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10, marginBottom: 24 }}>
                <button
                  ...
                  style={{
                    padding: '10px 18px',
                    borderRadius: 999,
                    border: `1px solid ${temaFilter === null ? 'rgba(171,48,28,0.5)' : 'rgba(255,255,255,0.2)'}`,
                    background: temaFilter === null ? 'rgba(171,48,28,0.15)' : 'rgba(255,255,255,0.06)',
                    color: temaFilter === null ? '#C44532' : 'rgba(255,255,255,0.8)',
                    fontSize: 14,
                    cursor: 'pointer',
                    fontFamily: APP_FONT,
                  }}
                ...
                {temas.map((t) => (
                  <button
                    ...
                    style={{
                      padding: '10px 18px',
                      borderRadius: 999,
                      border: `1px solid ${temaFilter === t ? 'rgba(171,48,28,0.5)' : 'rgba(255,255,255,0.2)'}`,
                      background: temaFilter === t ? 'rgba(171,48,28,0.15)' : 'rgba(255,255,255,0.06)',
                      color: temaFilter === t ? '#C44532' : 'rgba(255,255,255,0.8)',
                      fontSize: 14,
                      cursor: 'pointer',
                      fontFamily: APP_FONT,
                    }}
