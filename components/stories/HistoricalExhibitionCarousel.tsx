                      ...
                      {openHandler && isActiveSlide ? (
                        <button
                          ...
                          className={`relative z-10 mt-4 w-full rounded-full px-4 py-[0.7rem] text-center text-xs font-bold uppercase tracking-[0.17em] transition sm:text-[0.8rem] ${
                            canOpenThis
                              ? 'border border-orange-500/41 bg-[linear-gradient(165deg,#FF6E49_0%,#FF4A1C_52%,#D13D17_100%)] text-white shadow-[0_18px_40px_rgba(255,74,28,0.22)] hover:brightness-[1.03] active:scale-[0.99]'
