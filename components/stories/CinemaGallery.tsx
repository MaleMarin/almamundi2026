...
function defaultAvatar(name: string): string {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
    <circle cx="50" cy="50" r="50" fill="#B53514" opacity="0.3"/>
    <text x="50" y="64" font-family="serif" font-size="46" font-weight="300"
          fill="#FF4A1C" text-anchor="middle">${initial}</text>
  </svg>`;
...
export function CinemaGallery({ stories, onSelectStory }: CinemaGalleryProps) {
  ...
  if (!stories.length) {
    return (
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100%', color: '#FF4A1C', fontFamily: 'Georgia, serif', fontSize: '1.1rem' }}>
  ...
  return (
    <>
      <style>{`
        ...
        /* Play button pulse */
        @keyframes ringPulse {
          0%,100% { box-shadow: 0 0 0 0 rgba(255,74,28,0.35); }
          50%      { box-shadow: 0 0 0 18px rgba(255,74,28,0); }
        }
        .cg-play-btn:not(:hover) { animation: ringPulse 2.8s ease infinite; }
        .cg-play-btn { transition: transform 0.2s, background 0.2s; }
        .cg-play-btn:hover { transform: scale(1.1) !important; background: rgba(255,74,28,0.25) !important; }
      ...
      >
        ...
        <div style={{
          ...
          {story?.videoUrl ? (
            ...
            >
              <svg width="28" height="28" viewBox="0 0 24 24" fill="#FF4A1C">
                ...
                >
                  {thumb ? (
                    ...
                    <div style={{
                      ...
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="rgba(255,74,28,0.4)">
