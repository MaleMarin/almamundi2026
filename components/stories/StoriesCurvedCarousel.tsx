            ...
            <>
              ...
              {selected.videoUrl ? (
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 w-14 h-14 rounded-full bg-[var(--almamundi-orange,#FF4A1C)] hover:opacity-90 text-white transition-colors mb-6"
