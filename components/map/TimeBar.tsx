 ...
 *
 * Incluye nota sobre sonificación (sin franja extra de texto día/noche).
...
export function TimeBar({ selectedLocation, className }: Props) {
  ...
  return (
    <div className="pointer-events-none flex w-full max-w-[min(96vw,560px)] flex-col items-center gap-2 px-2 text-center">
