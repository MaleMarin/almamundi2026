    ...
    >
      <button
        ...
        style={{
          ...
          border: soundEnabled ? '1px solid var(--almamundi-orange)' : undefined,
          background: soundEnabled ? 'var(--almamundi-orange)' : NEO_BG,
          color: soundEnabled ? '#ffffff' : 'rgba(255,255,255,0.7)',
          cursor: 'pointer',
          outline: 'none',
