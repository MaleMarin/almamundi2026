      ...
      >
        <div
          style={{
            ...
            color: '#ff5a14',
            marginBottom: '10px',
            textShadow: '0 0 18px rgba(255, 74, 28, 0.45)',
          }}
        >
          Noticias en vivo
        </div>
          ...
          {TOPICS.map((t) => (
            <button
              ...
              style={{
                ...
                background:
                  activeTopic === t.id
                    ? 'linear-gradient(180deg, rgba(255, 74, 28, 0.55) 0%, rgba(255, 74, 28, 0.32) 100%)'
                    : 'linear-gradient(180deg, rgba(255,255,255,0.14) 0%, rgba(255,255,255,0.05) 100%)',
                backdropFilter: 'blur(12px)',
                WebkitBackdropFilter: 'blur(12px)',
                boxShadow:
                  activeTopic === t.id
                    ? 'inset 0 1px 0 rgba(255, 200, 150, 0.45), 0 0 16px rgba(255, 74, 28, 0.35)'
