...
export function Footer({ embedded = false }: FooterProps = {}) {
  return (
    ...
    >
      ...
      <div className="w-full max-w-6xl flex flex-col md:flex-row justify-between items-center md:items-end gap-12 pt-4 md:pt-6 pb-8 text-lg font-normal text-black">
