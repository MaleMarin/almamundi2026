              ...
              <div className="flex flex-wrap items-end justify-end gap-2">
                {shareTarget ? (
                  <EthicalShareTriggerButton
                    ...
                    className="min-h-9 min-w-9 shrink-0 rounded-full border border-gray-300/35 bg-[#E0E5EC] text-gray-700 shadow-[2px_2px_6px_rgba(163,177,198,0.45),-2px_-2px_6px_rgba(255,255,255,0.85)] hover:bg-[#d8dde6]"
                  />
                ) : null}
                <button
                  type="button"
