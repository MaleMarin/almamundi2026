...
export function StoryCaptureStep({
  ...
  return (
      <FormatCaptureEditorialShell
        ...
        continueLabel={continueButtonLabel || 'Continuar'}
      >
            ...
            <div style={neoSurface} className="p-6 md:p-8 space-y-5">
              ...
              {phase === 'idle' && (
                <button
                  ...
                  style={{ background: orangeCta, boxShadow: '0 8px 24px rgba(255,74,28,0.35)' }}
                >
                  Activar cámara
                </button>
              )}
                  ...
                  {!recording ? (
                    <button
                      ...
                      onClick={startRecording}
                          ...
                          style={{ background: orangeCta, boxShadow: '0 6px 20px rgba(255,74,28,0.3)' }}
                    >
                          Empezar grabación
                    </button>
                  ) : (
    ...
    <section className="space-y-8 md:space-y-10" aria-label="Captura de tu historia" aria-current="step">
      ...
      <button
        ...
        style={{
          ...
          boxShadow: canContinue() ? '0 10px 32px rgba(255,74,28,0.4)' : 'none',
        }}
      >
            {continueButtonLabel}
      </button>
